...
// creates the modify vehicle form
    ...
    $form_modify->addInputText('brand', 'col-9', $vehicle->getBrand());
    $form_modify->addInputText('model', 'col-9', $vehicle->getModel());
    $form_modify->addInputText('price', 'col-9', $vehicle->getPrice());
